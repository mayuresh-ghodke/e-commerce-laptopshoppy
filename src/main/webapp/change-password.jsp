		      		...
		      		<form action="ChangePassword" method="post" class="form">	      		
			      		<div class="card card-body">	      	 			
							...
							<div class="form-group">
								...
								<input type="text" name="currentpassword" class="form-control" id="email" placeholder="Enter Your Current Password">
							</div>
							<div class="form-group">
						 ...
						 <div class="card card-footer">
					        ...
					        <button class="btn btn-light mt-3" ><a href="login.jsp" class="text-dark" style="text-decoration:none">Cancel</a></button>
					     </div>		      	
		      		</form>
		      </div>
		    </div>  
